...
namespace FuncAndAction
{
    public class EntryPoint
    {
        static void Main()
        {
            ...
            Func<string, bool> hasLetterA = x => x.ToLower().Contains("a");
            ...
            List<string> namesLetterA = ExtractStrings(names, hasLetterA);
            ...
            Console.WriteLine("Names containing the letter a: " + string.Join(", ", namesLetterA));
            Console.WriteLine(new string('-', 40));
